...
def edit_project(request, id):
    ...
    form = CreateProjectForm(initial = {'project_name': project.project_name,
                                        ...
                                        'start_date': dt.datetime.strptime(str(project.start_date), '%Y-%m-%d').strftime(DATE_FORMAT),
                                        'end_date': dt.datetime.strptime(str(project.end_date), '%Y-%m-%d').strftime(DATE_FORMAT),
