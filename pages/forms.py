...
class CreateProjectForm(forms.Form):
    ...
    project_description = forms.CharField(required=False,empty_value=None,label='Projektin kuvaus',max_length=500,widget=forms.Textarea(attrs={'cols':50,'rows':5,'autocomplete':'off'}))
