...
class CreateProjectForm(forms.Form):
    ...
    project_description = forms.CharField(required=False,empty_value=None,label='Projektin kuvaus',max_length=1000,widget=forms.Textarea(attrs={'cols':50,'rows':5}))
    documentation_path = forms.CharField(required=False,empty_value=None,label='Polku tiedostojen sijaintiin',max_length=500,widget=forms.TextInput(attrs={'autocomplete':'off'}))
