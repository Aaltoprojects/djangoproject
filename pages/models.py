...
class Project(models.Model):
	...
	keywords = models.CharField(null=True,max_length=200, verbose_name='Avainsanat')
	project_description = models.CharField(null=True,max_length=1000, verbose_name='Projektin kuvaus')
	documentation_path = models.CharField(null=True,max_length=500, verbose_name='Polku tiedostojen sijaintiin')
	project_manager = models.CharField(null=True,max_length=100, verbose_name='Projektin vetäjä')
