...
class Project(models.Model):
	...
	destination_name = models.CharField(max_length=200,default=None)
	start_date = models.DateField()
	end_date = models.DateField()
	#4 Structure types, but keep more until confirmed
	#Asuin-, Liike-, Teollisuus-, Geokohde
	structure_type = models.IntegerField(default=None,validators=[MaxValueValidator(10),MinValueValidator(1)])
	...
	construction_operation = models.IntegerField(default=None,validators=[MaxValueValidator(10),MinValueValidator(1)])
